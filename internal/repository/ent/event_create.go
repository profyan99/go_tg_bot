...
func (ec *EventCreate) SetCreateAt(t time.Time) *EventCreate {
	ec.mutation.SetCreateAt(t)
	return ec
}

// SetNillableCreateAt sets the "create_at" field if the given value is not nil.
func (ec *EventCreate) SetNillableCreateAt(t *time.Time) *EventCreate {
	if t != nil {
		ec.SetCreateAt(*t)
	}
	return ec
...
func (ec *EventCreate) SetUpdateAt(t time.Time) *EventCreate {
	ec.mutation.SetUpdateAt(t)
	return ec
}

// SetNillableUpdateAt sets the "update_at" field if the given value is not nil.
func (ec *EventCreate) SetNillableUpdateAt(t *time.Time) *EventCreate {
	if t != nil {
		ec.SetUpdateAt(*t)
	}
	return ec
...
func (ec *EventCreate) defaults() {
	if _, ok := ec.mutation.CreateAt(); !ok {
		v := event.DefaultCreateAt()
		ec.mutation.SetCreateAt(v)
	}
	if _, ok := ec.mutation.UpdateAt(); !ok {
		v := event.DefaultUpdateAt()
		ec.mutation.SetUpdateAt(v)
	}
...
func (ec *EventCreate) check() error {
	if _, ok := ec.mutation.CreateAt(); !ok {
		return &ValidationError{Name: "create_at", err: errors.New(`ent: missing required field "Event.create_at"`)}
	}
	if _, ok := ec.mutation.UpdateAt(); !ok {
		return &ValidationError{Name: "update_at", err: errors.New(`ent: missing required field "Event.update_at"`)}
	}
...
func (ec *EventCreate) createSpec() (*Event, *sqlgraph.CreateSpec) {
	...
	if value, ok := ec.mutation.CreateAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: event.FieldCreateAt,
		})
		_node.CreateAt = value
	}
	if value, ok := ec.mutation.UpdateAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
